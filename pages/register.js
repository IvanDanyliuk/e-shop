                        ...
                        <Controller 
                            ...
                            render={({ field }) => (
                                <TextField 
                                    ...
                                    helperText={errors.password ? errors.password.type === 'minLength' ? 'Password length is more then 5' : 'Password is required' : ''}
                                    {...field}
                                ></TextField>
                            )}
                        ></Controller>
                        ...
                        <Controller 
                            ...
                            render={({ field }) => (
                                <TextField 
                                    ...
                                    helperText={errors.confirmPassword ? errors.confirmPassword.type === 'minLength' ? 'Confirm password length is more then 5' : 'Confirm password is required' : ''}
                                    {...field}
                                ></TextField>
                            )}
                        ></Controller>
